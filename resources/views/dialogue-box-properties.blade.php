                        ...
                        <div class="form-group position-relative has-icon-left">
                            ...
                            <div class="dropdown-menu dropdown-demo project_employee_search" style="width: 100%;">
                                <div class="employee_list ">
                                    ...
                                    <a class="dropdown-item get-option" action="toggle" act-on="employee_list" option1="{{$value->jf_name}}" option1_to="del_to2" option3="481" option3_to="pm_name_1" url="#" activity_name=" " activity_name_set="content_title_2" property_a="" property_b="" property_c="" property_d="" property_e="" progress_name="biz_type_list2" progress_image="" data-target="#rollIn" result="biz_type_list"> {{$value->jf_name}} </a>
                                    @endforeach
