...
<div class="main-menu material-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="user-profile">
        <div class="user-info text-center pb-2"><img class="user-img img-fluid rounded-circle w-25 mt-2" src="app-assets/images/portrait/small/avatar-s-1.png" alt="" />
            <div class="name-wrapper d-block dropdown mt-1"><a class="white dropdown-toggle" id="user-account" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-name">Charlie Adams</span></a>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="/"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
            ...
            <li class=" nav-item"><a href="/lease"><i class="material-icons">add_shopping_cart</i><span class="menu-title" data-i18n="eCommerce">Lease</span></a>
            </li>
            <li class=" nav-item"><a href="../material-travel-menu-template" ><i class="material-icons">call_merge</i><span class="menu-title" data-i18n="Travel &amp; Booking">Travel &amp; Booking</span></a>
            </li>
            <li class=" nav-item"><a href="../material-hospital-menu-template" ><i class="material-icons">add_circle_outline</i><span class="menu-title" data-i18n="Hospital">Hospital</span></a>
            </li>
            <li class=" nav-item"><a href="../material-crypto-menu-template" ><i class="material-icons">attach_money</i><span class="menu-title" data-i18n="Crypto">Crypto</span></a>
            </li>
            <li class=" nav-item"><a href="../material-support-menu-template" ><i class="material-icons">label_outline</i><span class="menu-title" data-i18n="Support Ticket">Support Ticket</span></a>
            </li>
            <li class=" nav-item"><a href="../material-bank-menu-template" ><i class="material-icons">account_balance</i><span class="menu-title" data-i18n="Bank">Bank</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="material-icons">code</i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-1-column.html"><i class="material-icons"></i><span data-i18n="1 column">1 column</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-2-columns.html"><i class="material-icons"></i><span data-i18n="2 columns">2 columns</span></a>
                    </li>
                    <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Content Det. Sidebar">Content Det. Sidebar</span></a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-left-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached left sidebar">Detached left sidebar</span></a>
                            </li>
                            <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-left-sticky-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</span></a>
                            </li>
                            <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-right-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached right sidebar">Detached right sidebar</span></a>
                            </li>
                            <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-content-detached-right-sticky-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navbar.html"><i class="material-icons"></i><span data-i18n="Fixed navbar">Fixed navbar</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navigation.html"><i class="material-icons"></i><span data-i18n="Fixed navigation">Fixed navigation</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navbar-navigation.html"><i class="material-icons"></i><span data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed-navbar-footer.html"><i class="material-icons"></i><span data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</span></a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-fixed.html"><i class="material-icons"></i><span data-i18n="Fixed layout">Fixed layout</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-boxed.html"><i class="material-icons"></i><span data-i18n="Boxed layout">Boxed layout</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-static.html"><i class="material-icons"></i><span data-i18n="Static layout">Static layout</span></a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-light.html"><i class="material-icons"></i><span data-i18n="Light layout">Light layout</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-dark.html"><i class="material-icons"></i><span data-i18n="Dark layout">Dark layout</span></a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/material-vertical-modern-menu-template/layout-semi-dark.html"><i class="material-icons"></i><span data-i18n="Semi dark layout">Semi dark layout</span></a>
                    </li>
                </ul>
            </li>
