            ...
            <div class="content-header-dark bg-img col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <h3 class="content-header-title white">Styling DataTable</h3>
                    ...
                    <div class="content-header-right col-md-3 col-12">
                        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item modal_activity get_content_to_append" content_from="new-user-dialogue-box-content" content_to="dialog-lg-result-1" data-backdrop="static" data-toggle="modal" data-target="#dialog-lg-1" url="/getUsers" activity_name="Create New Fleet" activity_name_set="dialog-lg-title-1" property_a="" property_b="" property_c="" property_d="" property_e="update_url" progress_name="dialog-lg-result-12" progress_image='<div align="center" class="ball-rotate loader-danger"><div></div></div>' result="dialog-lg-result-1"> New Lease </a>
                                <a class="dropdown-item" href="material-component-cards.html"> Cards</a><a class="dropdown-item" href="component-progress.html"> Progress</a>
